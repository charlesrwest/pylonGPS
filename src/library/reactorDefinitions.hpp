...
@throws: This function can throw exceptions
*/
template <class classType> void reactor<classType>::addInterface(zmq::socket_t *inputSocket, std::function<bool (classType*, reactor<classType> *, zmq::socket_t &)> inputMessageHandler)
{
...
while(true)
{
nextEventTime = eventHandlerFunction(eventQueue);
