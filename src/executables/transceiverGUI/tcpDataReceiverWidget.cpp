...
@param inputIPAddress: A string representing the IP address of the TCP server the receiver is getting data from
...
*/
tcpDataReceiverWidget::tcpDataReceiverWidget(const std::string &inputDataReceiverConnectionString, const std::string &inputIPAddress, int64_t inputPortNumber, QWidget *inputParent, Qt::WindowFlags inputFlags) : QFrame(inputParent, inputFlags)
{
setupUi(this);
...
IPAddressLabel->setText(QString(("TCP: " + IPAddress).c_str()));
...
*/
bool tcpDataReceiverWidget::eventFilter(QObject *inputObject, QEvent *inputEvent)
{
...
*/
void tcpDataReceiverWidget::makeDetailsDisappear()
{
...
*/
void tcpDataReceiverWidget::emitDataReceiverPlusButtonPressed()
{
...
*/
void tcpDataReceiverWidget::emitDataReceiverMinusButtonPressed()
{
...
*/
void tcpDataReceiverWidget::makeDetailsAppear()
{
setMaximumHeight(49);
...
@param inputEvent: The event signal
*/
bool tcpDataReceiverWidget::event(QEvent *inputEvent)
{
