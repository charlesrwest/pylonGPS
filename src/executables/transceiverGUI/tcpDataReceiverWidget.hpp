...
#include<QWidget>
#include "ui_tcpDataReceiverWidgetFramework.h"
#include<map>
...
/**
This class represents the widget which displays the details for a tcp data receiver and allows it to create related senders.
*/ 
class tcpDataReceiverWidget: public QFrame, public Ui::tcpDataReceiverGUIWidget
{
Q_OBJECT
...
*/
tcpDataReceiverWidget(const std::string &inputDataReceiverConnectionString, const std::string &inputIPAddress, int64_t inputPortNumber, QWidget *inputParent = 0, Qt::WindowFlags inputFlags = 0);
