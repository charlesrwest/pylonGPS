...
*/
tcpDataSenderWidget::tcpDataSenderWidget(const std::string &inputDataSenderIDString, int64_t inputPortNumber, QWidget *inputParent, Qt::WindowFlags inputFlags) : QFrame(inputParent, inputFlags)
{
setupUi(this);
...
*/
bool tcpDataSenderWidget::eventFilter(QObject *inputObject, QEvent *inputEvent)
{
...
*/
void tcpDataSenderWidget::makeDetailsDisappear()
{
...
*/
void tcpDataSenderWidget::emitDataSenderMinusButtonPressed()
{
...
*/
void tcpDataSenderWidget::makeDetailsAppear()
{
setMaximumHeight(49);
...
@param inputEvent: The event signal
*/
bool tcpDataSenderWidget::event(QEvent *inputEvent)
{
