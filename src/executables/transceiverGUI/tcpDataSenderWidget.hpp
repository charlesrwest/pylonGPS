...
#include<QWidget>
#include "ui_tcpDataSenderWidgetFramework.h"
#include<map>
...
*/ 
class tcpDataSenderWidget: public QFrame, public Ui::tcpDataSenderGUIWidget
{
Q_OBJECT
...
*/
tcpDataSenderWidget(const std::string &inputDataSenderIDString, int64_t inputPortNumber, QWidget *inputParent = 0, Qt::WindowFlags inputFlags = 0);
